...
undum.game.situations = {
    start: new undum.SimpleSituation(
		...
		<img src='media/games/tutorial/pequeño.jpg' width='450' height='225' class='float_right'>\
    ...
    ir: new undum.SimpleSituation(
		...
		<img src='media/games/tutorial/diario.jpg' width='400' height='225' class='float_right'>\
    ...
    londres: new undum.SimpleSituation(
		...
		<img src='media/games/tutorial/londres.jpg' width='400' height='225' class='float_right'>\
    ...
    francia: new undum.SimpleSituation(
		...
		<img src='media/games/tutorial/chateau.jpg' width='400' height='225' class='float_right'>\
		...
		<b> Carta: </b> Señor Francis, la expedición concluyó como usted mandó, aguardaremos con el artefacto en el desierto de Arabia. <a href='avion'> Desierto Arabia </a> .\</p>",
        {
            heading: "Chateau",
            enter: function (character, system, from) {
                system.setQuality(
   ...
   avion: new undum.SimpleSituation(
        "<h1> Polizón. </h1>\
		<img src='media/games/tutorial/avion.jpg' width='450' height='225' class='float_right'>\
